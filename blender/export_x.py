# Blender model exporter - based on directX exporter #
...
#                    Object.Children.append(ExportMap[Child])
    ...
    def Export(self):
        ...
        # Write meshes
        self.Log("Writing meshes...")
        for Object in ExportList
            if Object.type == "MESH": self.__WriteMesh(Object)
        self.Log("Done");

        # Write skeleton structure
        self.Log("Writing objects...")
        self.__WriteSkeleton();
        self.Log("Done")
    ...
    def __WriteMesh(self, Object)
        self.Log("Writing mesh " + Object.BlenderObject.name)
        self.File.Write("<mesh name={}>\n", format(Object.BlenderObject.name))
        self.File.Indent()
        # Need to split meshes on materials, and optionally on tangents
