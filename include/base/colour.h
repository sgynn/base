...
inline Colour::Colour(unsigned c, float a): r(((c&0xff0000)>>16)/255.0f), g(((c&0xff00)>>8)/255.0f), b((c&0xff)/255.0f), a(a) {}
inline Colour::operator float*()             { return &r; }
inline Colour::operator const float*() const { return &r; }
inline Colour::operator unsigned() const     { return ((unsigned)(r*255)<<16) + ((unsigned)(g*255)<<8) + ((unsigned)(b*255)); }
